...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                var mouseMovement = GetInputLookRotation() * UnityEngine.Time.deltaTime * 5;
                if (invertY)
            ...
            // Translation
            var translation = GetInputTranslationDirection() * UnityEngine.Time.deltaTime;
            ...
            var positionLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / positionLerpTime) * UnityEngine.Time.deltaTime);
            var rotationLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / rotationLerpTime) * UnityEngine.Time.deltaTime);
